...
let internal typedAppSettings (context: Context) assy =
   let appSettings = context.ErasedType(assy, rootNamespace, "AppSettings")
       ...
       instantiationFunction = (fun typeName parameterValues ->
           let value = lazy (
               ...
               | [| :? string as configFileName |] ->
                   let typeDef = context.ErasedType(assy, rootNamespace, typeName)
                   let niceName = createNiceNameProvider()
                   try
                       ...
                       for key in appSettings.AllKeys do
                           ...
                           let prop =
                               ...
                               | ValueParser.Bool _ ->
                                   ProvidedProperty(name, typeof<bool>, isStatic = true,
                               ...
                               | ValueParser.Float _ ->
                                   ProvidedProperty(name, typeof<float>, isStatic = true,
                               ...
                               | ValueParser.TimeSpan _ ->
                                   ProvidedProperty(name, typeof<TimeSpan>, isStatic = true,
                               ...
                               | ValueParser.DateTime _ ->
                                   ProvidedProperty(name, typeof<DateTime>, isStatic = true,
                               ...
                               | ValueParser.Guid _ ->
                                   ProvidedProperty(name, typeof<Guid>, isStatic = true,
           ...
           cache.GetOrCreate (typeName, fun e -> value.Force())))
   appSettings